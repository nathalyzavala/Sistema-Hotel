                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form id="form-empresa" action="" method="GET" class="form-horizontal">
                                    <div class="box-body">
                                        ...
                                        <div class="box-footer">
                                            <div class="form-group">
                                                <div class="col-sm-6">
                                                    <button id="limpiar" name="limpiar" type="submit" class="btn btn-primary pull-right"><span class="fa fa-save"></span> Guardar</button>
                                                </div>
                                                <div class="col-sm-3">
                                            ...
                                            <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr id="<%= r.getIdreserva()%>">
                                                        ...
                                                        <td data-target="idreserva"><%= r.getIdreserva()%></td>
        ...
        <script>
            ...
            $(document).ready(function () {
                $(document).on('click', 'a[data-role=update]', function () {
                    var id = $(this).data('id');
                    var idreserva = $('#' + id).children('td[data-target=idreserva]').text();
...
<!--<script>
    $(document).ready(function () {
        ...
        var fila;//captura la fila para eliminar el registro
        /*boton editar*/
        $(document).on('click', 'a[data-role=update]', function () {
            var id = $(this).data('id');
            var categoria = $('#' + id).children('td[data-target=categoria]').text();
            /*capturando los datos con el val*/
            $('#idcategoria').val(id);
        ...
        //metodo para poder setear los valores correspondientes
        $('#save').click(function () {
            ...
            $.ajax({
                url: 'EditarCategorias.do',
                method: 'GET',
                data: {idcategoria: idcategoria, categoria: categoria},
                success: function (response) {
                    $('#' + idcategoria).children('td[data-target=categoria]').text(categoria);
                    $('#myModal').modal('toggle');
                }
            });
