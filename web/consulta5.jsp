...
<html>
    <head>
        ...
        <title>Empleados con sus Cargos</title>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header col-sm-11">
                                    <h3 class="box-title">Empleados con sus cargos</h3>
                                </div>
                                <div class="col-sm-1"> 
                                ...
                                <div class="box-body">
                                    <table id="example1" class="table data-table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <%
                                                List<Empleado> listem = (List<Empleado>) request.getAttribute("listaempleado");
