...
<html>
    <head>
        ...
        <title>Productos con sus Categorias</title>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header col-sm-11">
                                    <h3 class="box-title">Productos con sus Categorias</h3>
                                </div>
                                <div class="col-sm-1"> 
                                ...
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <%
                                                List<Producto> lstpro = (List<Producto>) request.getAttribute("listaproductos");

                                                for (Producto p : lstpro) {
                                            %>
                                            <tr>
                                                <td><%= p.getNombre() %></td>
